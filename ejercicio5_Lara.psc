...
//el error que encontramos es que en la funcion max y min no estan dados por referencia, Entonces
// cuando en el proceso busca quien es max y min, como no estan inicializadas da error
// para que funciones el codigo hay que poner CalcularMaxMin(vector,size,max,min) en vez de 
// CalcularMaxMin(vector,size,max,min)
