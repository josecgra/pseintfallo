...
Funcion CalcularMaxMin(vector,size, max Por Referencia min Por Referencia) //se debía indicar que max 
	//y min se deben obtener por referencia, ya que se trata de un vector.
